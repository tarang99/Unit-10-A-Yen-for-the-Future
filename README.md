...
![Yen Photo](unit-10-readme-photo.jpeg)
...
1. Plotting the Settle price to check for long or short-term patterns.
    ...
    * Do you see any patterns, long-term and/or short?
    The long term pattern looks that it is getting stronger.
...
It looks like the Yen will get stronger against CAD.
5. Forecasting volatility with GARCH.
   
    * What does the model forecast will happen to volatility in the near term?
    Based on the model forecast, it looks like the volatility will increase in the near term.
...
* Does this model perform better or worse on out-of-sample data compared to in-sample data?
    This models perfoms better on out-of-sample compared to in-sample-data.
- - -
